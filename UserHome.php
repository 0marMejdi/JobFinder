        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-6">
                  <p class="card-text"><span class="bi bi-geo-alt"></span> San Francisco, CA</p>
                </div>
                <div class="col-md-6">
                  <p class="card-text"><span class="bi bi-clock"></span> Freelance</p>
                </div>
              </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <img src="assets/img/team/team-1.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title"><a href="#">Software Developer</a></h5>
              <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                incididunt ut labore et dolore magna aliqua.</p>
              <div class="row">
                <div class="col-md-6">
                  <p class="card-text"><span class="bi bi-geo-alt"></span> Austin, TX</p>
                </div>
                <div class="col-md-6">
                  <p class="card-text"><span class="bi bi-clock"></span> Full Time</p>
                </div>
              </div>
              <a href="#" class="btn btn-primary">Apply Now</a>
            </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <img src="assets/img/team/team-1.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title"><a href="#">Data Analyst</a></h5>
              <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                incididunt ut labore et dolore magna aliqua.</p>
              <div class="row">
                <div class="col-md-6">
                  <p class="card-text"><span class="bi bi-geo-alt"></span> Chicago, IL</p>
                </div>
                <div class="col-md-6">
                  <p class="card-text"><span class="bi bi-clock"></span> Part Time</p>
                </div>
              </div>
              <a href="#" class="btn btn-primary">Apply Now</a>
            </div>
